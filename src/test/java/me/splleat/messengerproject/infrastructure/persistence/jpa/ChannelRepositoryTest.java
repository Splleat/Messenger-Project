...
class ChannelRepositoryTest {
    ...
    void setUp() {
        ...
        for (int i = 0; i < 5; i++) {
            Channel channel = ChannelFixture.groupChannel(group.getId());
    ...
    @Test
    @DisplayName("findAllChannelIdByGroupId: 특정 그룹에 속한 채널 ID 목록을 반환한다.")
    void findAllChannelIdByGroupId() {
        // given
        ...
        // when
        List<Long> found = channelRepository.findAllChannelIdByGroupId(group.getId());
